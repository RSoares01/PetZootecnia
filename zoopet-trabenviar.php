...
if(isset($_FILES) && (bool) $_FILES) {
  ...
  foreach($_FILES as $name=>$file) {
    ...
    if(!in_array($ext,$allowedExtensions)) {
      die("Arquivo $file_name possui a extensão $ext que não é aceita");
    }
...
<br><strong>Nome da IES (Instituição de Ensino Superior):</strong> $nomeies
<br><strong>Grupo PET:</strong> $grupo
...
<!--<li class="nav-item"><a class="nav-link">MINHOCÁRIO <!--<i class="fas fa-caret-down"></i>--></a> 
  ...
  <div class="site-section mb-5">
    <div class="container"><h2>Trabalhos enviados!</h2>
      <div class="row mb-5">
